                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.status ==='error') {
                            ...
                            detailsHtml += "<tr><td>Order ID</td><td><a href='warehouse-order-details.php?id=" + response.order_id + "' target='_blank'>" + response.order_id + "</a></td></tr>";
