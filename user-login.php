            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status === "error") {
                        ...
                        if (response.level === "Driver") {
                            window.location.href = "driver-dashbord.php";
                        }
                        else if (response.level === "Agent") {
                            window.location.href = "new-invoice.php";
                        }
                        else if (response.level === "Admin") {
                            window.location.href = "dashbord.php";
                        }
                        else if(response.level === "Warehouse Manager"){
                            window.location.href = "warehouse-dashbord-searchbyInvoice.php";
                        }
                        else {
