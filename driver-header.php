<?php
 session_start();
 if (!isset($_SESSION['username']) || $_SESSION['level'] !== 'Driver') {
        ...
        <ul class="sidebar-menu tf">
            ...
            <li class="sidebar-submenu">
                ...
                <ul class="sidebar-menu sidebar-menu-dropdown-content">
                    <li>
                        <a href="driver-dashbord.php">
                            Dashboard
                        </a>
                    </li>
                    <li>
                        <a href="driver-allorders.php">
                            All Orders
                        </a>
                    </li>
                </ul>
    ...
    <div class="d-flex align-items-center">
        ...
        <div class="dropdown d-inline-block mt-12">
            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img class="rounded-circle header-profile-user" style="width: 60px;" src="images/profile/driver-icon.png"
                    alt="Header Avatar">
            ...
            <div class="dropdown-menu dropdown-menu-end">
                <!-- item-->
                <a class="dropdown-item" href="driver-profile.php"><i class="bx bx-user font-size-16 align-middle me-1"></i>
                    <span>Profile</span></a>
