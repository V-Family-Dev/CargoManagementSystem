                                ...
                                <div class="col-md-6 col-sm-12 mb-24">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" onchange="hideDiliveryDate1(this)"
                                            name="flexRadioDefault" id="pickuponly" value="Pick Up Only">
                                ...
                                <div class="col-md-6 col-sm-12 mb-24">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" onchange="hideDiliveryDate2(this)"
                                            name="flexRadioDefault" id="pickupanddelivery" value="Pick Up and Delivery" checked>
                            ...
                            <form id="orderForm" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-12 mb-24">
                                        <div class="form-group"> <label class="form-label">Box Type</label> <select
                                                class="form-control" aria-label="Default select example" id="boxtype" required>
                                                <option selected>Choose..</option>
                                                <option value="XXL/Trunk">XXL/Trunk</option>
                                                <option value="XL/Trunk">XL/Trunk</option>
                                                <option value="L/Trunk">L/Trunk</option>
                                                <option value="M/Trunk">M/Trunk</option>
                                                <option value="S/Trunk">S/Trunk</option>
                                                <option value="Cortoon">Cortoon</option>
                                ...
                                <div class="col-md-6 col-sm-12 mb-24">
                                        <div class="form-group" id="delivery-driver-group">
                                            ...
                                            <select class="form-control" id="delivery-driver" name="delivery-driver" required>
                                                <option value="">--Select a driver--</option>
                                                <?php
                                                    $query = "SELECT username FROM user WHERE level_id = 4";
                                    ...
                                    <div class="col-md-6 col-sm-12 mb-24">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <select class="form-control" id="pickup-driver" name="pickup-driver" required>
                                                    <option value="">--Select a Pickup Driver--</option>
                                                    <?php                     
                                                        $query = "SELECT username FROM user WHERE level_id = 4";
                                                        $result = $conn->query($query);
                                                        if ($result->num_rows > 0) {                                                           
