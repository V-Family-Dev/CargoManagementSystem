<?php
//session_start();
if (!isset($_SESSION['username']) || ($_SESSION['level'] !== 'Agent' && $_SESSION['level'] !== 'Admin')) {
    ...
    <div class="d-flex align-items-center">
        ...
        <div class="dropdown d-inline-block mt-12">
            ...
            <div class="dropdown-menu dropdown-menu-end">
                <!-- item-->
                <a class="dropdown-item" href="agent-profile.php"><i class="bx bx-user font-size-16 align-middle me-1"></i>
                    <span>Profile</span></a>
